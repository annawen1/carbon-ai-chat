...
The chat history components emit several custom events that you can listen for to handle user interactions:

#### `history-item-action`

Fired when a user clicks on an action in the overflow menu of a history panel item.

**Event Detail Properties:**
- `action` (string) - The text of the action that was clicked (e.g., "Rename", "Delete", "Pin")
- `itemId` (string) - The ID of the history item
- `itemTitle` (string) - The title of the history item
- `element` (HTMLElement) - Reference to the `cds-aichat-history-panel-item` element
...
document.addEventListener('history-item-action', (event) => {
  ...
  switch(action) {
    case 'Rename':
      // Enable rename mode on the item
      element.rename = true;
      break;
    case 'Delete':
...
Fired when the user types in the search field of the history toolbar.
...
#### `cds-aichat-history-panel-item-input-save`

Fired when the user saves a renamed history item.

**Event Detail Properties:**
- `newTitle` (string) - The new title entered by the user
- `itemId` (string) - The ID of the history item being renamed
...
#### `cds-aichat-history-panel-item-input-cancel`

Fired when the user cancels renaming a history item (e.g., by pressing Escape or clicking outside).

**Example:**
```javascript
document.addEventListener('cds-aichat-history-panel-item-input-cancel', (event) => {
